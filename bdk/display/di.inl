...
* Copyright (c) 2018-2024 CTCgram is free software; you can redistribute it and/or modify it
...
#if PALETTE_BITS == 1
#define WIN_COLOR_DEPTH_P WIN_COLOR_DEPTH_P1
#elif PALETTE_BITS == 2
#define WIN_COLOR_DEPTH_P WIN_COLOR_DEPTH_P2
#elif  PALETTE_BITS == 4
#define WIN_COLOR_DEPTH_P WIN_COLOR_DEPTH_P4
#elif  PALETTE_BITS == 8
#define WIN_COLOR_DEPTH_P WIN_COLOR_DEPTH_P8
#else
#error "PALETTE_BITS not 1, 2, 4, 8"
#endif
...
static const reg_cfg_t _di_winA_pitch_small_palette[] = {
	...
	{DC_WIN_WIN_OPTIONS, 0},
	{DC_DISP_DISP_WIN_OPTIONS, DSI_ENABLE},
	{DC_WIN_COLOR_DEPTH, WIN_COLOR_DEPTH_P}, // NX Default: T_A8B8G8R8, WIN_COLOR_DEPTH_R8G8B8A8.
	{DC_WIN_POSITION, V_POSITION(WIN_POS_Y) | H_POSITION(WIN_POS_X)},
	{DC_WIN_H_INITIAL_DDA, 0},
	{DC_WIN_V_INITIAL_DDA, 0},
	{DC_WIN_PRESCALED_SIZE, V_PRESCALED_SIZE(WIN_HEIGHT) | H_PRESCALED_SIZE((WIN_WIDTH + PIXELS_PER_BYTE - 1) / PIXELS_PER_BYTE)},

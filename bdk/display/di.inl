...
//Display A config linear pitch small.
#define WIN_ZOOM 4
...
static const cfg_op_t cfg_display_small_framebuffer_pitch[32] = {
	{DC_CMD_DISPLAY_WINDOW_HEADER, WINDOW_C_SELECT},
	{DC_WIN_WIN_OPTIONS, 0},
	{DC_CMD_DISPLAY_WINDOW_HEADER, WINDOW_B_SELECT},
	{DC_WIN_WIN_OPTIONS, 0},
	...
	{DC_WIN_H_INITIAL_DDA, 0},
	{DC_WIN_V_INITIAL_DDA, 0},
	{DC_WIN_PRESCALED_SIZE, V_PRESCALED_SIZE(WIN_HEIGHT) | H_PRESCALED_SIZE(WIN_WIDTH * 4)},
	{DC_WIN_DDA_INC, V_DDA_INC(WIN_DDA) | H_DDA_INC(WIN_DDA)}, // 1.0x.
	{DC_WIN_SIZE, V_SIZE(WIN_HEIGHT * WIN_ZOOM) | H_SIZE(WIN_WIDTH * WIN_ZOOM)},
	{DC_WIN_LINE_STRIDE, UV_LINE_STRIDE(WIN_WIDTH * 2) | LINE_STRIDE(WIN_WIDTH * 4)}, // 720*2x720*4 (= 0x600 x 0xC00) bytes, see TRM for alignment requirements.
	{DC_WIN_BUFFER_CONTROL, BUFFER_CONTROL_HOST},
	{DC_WINBUF_SURFACE_KIND, PITCH},
...
#define DC_WINC_COLOR_PALETTE_EXT 0x600

static const cfg_op_t cfg_display_small_framebuffer_pitch1[24] = {
	{DC_CMD_DISPLAY_WINDOW_HEADER, WINDOW_A_SELECT},
	{DC_DISP_DISP_WIN_OPTIONS, DSI_ENABLE},

	{DC_WINBUF_SURFACE_KIND, PITCH},
	{DC_WIN_COLOR_DEPTH, WIN_COLOR_DEPTH_P8}, // NX Default: T_A8B8G8R8, WIN_COLOR_DEPTH_R8G8B8A8.
	{DC_WIN_POSITION, V_POSITION(WIN_POS_Y) | H_POSITION(WIN_POS_X)},
	{DC_WIN_PRESCALED_SIZE, V_PRESCALED_SIZE(WIN_HEIGHT) | H_PRESCALED_SIZE(WIN_WIDTH)},
	{DC_WIN_SIZE, V_SIZE(WIN_HEIGHT * WIN_ZOOM) | H_SIZE(WIN_WIDTH * WIN_ZOOM)},
	{DC_WIN_LINE_STRIDE, LINE_STRIDE((WIN_WIDTH + 0xf) & ~0xf)},
	{DC_WIN_DDA_INC, V_DDA_INC(WIN_DDA) | H_DDA_INC(WIN_DDA)},
	{DC_WIN_H_INITIAL_DDA, 0},
	{DC_WIN_V_INITIAL_DDA, 0},
	
	{DC_WIN_BUFFER_CONTROL, BUFFER_CONTROL_HOST},

	{DC_WINC_COLOR_PALETTE,     0x000000},
	{DC_WINC_COLOR_PALETTE + 1, 0xffffff},
	{DC_WINC_COLOR_PALETTE + 2, 0x737373},
	{DC_WINC_COLOR_PALETTE_EXT, 0x0},
	...
	{DC_DISP_DISP_WIN_OPTIONS, DSI_ENABLE},
	{DC_WIN_WIN_OPTIONS, WIN_ENABLE | (1 << 16)}, // Enable window AD. Enable color palette.
	{DC_CMD_DISPLAY_COMMAND, DISP_CTRL_MODE_C_DISPLAY}, // Continuous display.

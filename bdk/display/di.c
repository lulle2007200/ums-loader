...
#define DC_WIN_AD_PALETTE         0xaff
#define DC_WIN_BD_PALETTE         0xcff
#define DC_WIN_CD_PALETTE         0xeff
#define DC_WIN_AD_PALETTE_EXT     0xb00
#define DC_WIN_BD_PALETTE_EXT     0xd00
#define DC_WIN_CD_PALETTE_EXT     0xf00
u32 *display_init_small_framebuffer_pitch()
{
	// Sanitize framebuffer area.
	memset((u32 *)IPL_SMALL_FB_ADDR, 0xff, SZ_32K);

	// This configures the framebuffer @ IPL_SMALL_FB_ADDR with a resolution of 128x64 (line stride 64) and x8 scale.
	exec_cfg((u32 *)DISPLAY_A_BASE, cfg_display_small_framebuffer_pitch, 32);
	usleep(35000); // No need to wait on Aula.
...
{
	// Sanitize framebuffer area.
	memset((u32*)IPL_SMALL_FB_ADDR, 0x0, 0xf000);

	// This configures the framebuffer @ IPL_SMALL_FB_ADDR with a resolution of 128x64 (line stride 64) and x8 scale.
	exec_cfg((u32 *)DISPLAY_A_BASE, cfg_display_small_framebuffer_pitch1, 24);
